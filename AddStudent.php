...
if($_SERVER['REQUEST_METHOD'] == "POST"){
  if(isset($_POST['add'])){
    ...
    if($success){
        $query="insert into student (name,phone,gender) values(?,?,?)";
        $st=$conn->prepare($query);
        $st->bind_param("sis", $name, $phone, $gender);
        $st->execute();
        $name="";
        $phone="";
        $gender="";
       ...
       <div class="card card-primary">
             ...
             <form method="post">
               ...
               <div class="card-footer">
                  <button type="submit" value="Add" class="btn bg-gradient-success btn-lg mb-2" style="float:right;" name="add">Add Student</button>
                </div>
                <div class="card-footer">
                  <a href="1-admin.php" class="btn btn-light">Cancel</a>
                </div>
             </form>
           </div>
    </div>
