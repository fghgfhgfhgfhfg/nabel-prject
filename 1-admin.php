...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <a href="AddStudent.php">
      <button type="button" class="btn bg-gradient-success btn-lg mb-2" style="float:right;" name="adduser">Add student</button>
    </a>
                <table class="table table-bordered">
                  ...
                  <?php
                    ...
                    <tr>
                        ...
                        <td>
                          <a href="1-admin.php?r_id=<?php echo $row['id']?>" class="btn btn-danger"> Delete</a>
                        </td>
                        <td>
                          <a href="1-EdtAStudent.php?r_id=<?php echo $row['id']?>" class="btn btn-success">Update</a>
                        </td>
                    </tr>
                    <?php
                      }
